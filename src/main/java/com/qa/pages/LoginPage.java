...
public class LoginPage extends TestBase {
	...
	public LoginPage() { // Constructor of Loogin Page
		...
		// this means current class object which we have defined like email,
		// password,login button, signUp
	}
	...
	public HomePageAfterSignIn validateLogin(String mailId, String pwd) {
		email.clear();
